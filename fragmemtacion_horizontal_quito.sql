...
-- Crear tabla para alumnos de Quito
CREATE TABLE alumno_quito LIKE alumno;
-- Esta sentencia crea una nueva tabla 'alumno_quito' con la misma estructura que la tabla original 'alumno'.
 (
