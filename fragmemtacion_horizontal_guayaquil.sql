-- Crear tabla para alumnos de Guayaquil
CREATE TABLE alumno_guayaquil LIKE alumno;
-- Esta sentencia crea una nueva tabla 'alumno_guayaquil' con la misma estructura que la tabla original 'alumno'. (
 ...
 Mover datos de alumnos de Ambato
INSERT INTO alumno_guayaquil 
SELECT * FROM alumno 
WHERE ciudad = 'guayaquil';
-- Esta sentencia copia todos los registros de la tabla 'alumno' donde la ciudad es 'Ambato' a la nueva tabla 'alumno_ambato'.
